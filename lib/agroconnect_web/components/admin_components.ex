  ...
  def admin_sidebar(assigns) do
    ...
    <!-- Main navigation -->
      <nav class="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
        ...
        <.menu_item current_path={@current_path} path="/users" title="Users" />
        <.menu_item current_path={@current_path} path="/vets" title="Vets" />
        <.menu_item current_path={@current_path} path="/agrovets" title="Agrovets" />
        <.menu_item current_path={@current_path} path="/roles" title="Roles" />

        <div class="py-2 px-4">
          <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider">System</h3>
        </div>
        <.menu_item current_path={@current_path} path="/logs" title="Logs" />
      </nav>
    </aside>
    """
  end
