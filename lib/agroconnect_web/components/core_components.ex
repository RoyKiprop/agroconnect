defmodule AgroconnectWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-emerald-500 hover:bg-emerald-700 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AgroconnectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AgroconnectWeb.Gettext, "errors", msg, opts)
    end
  end
