defmodule AgroconnectWeb.AdminRole.Index do
  use AgroconnectWeb, :admin_live_view

  alias Agroconnect.Roles
  alias Agroconnect.Role
  ...
  @impl true
  def handle_info({AgroconnectWeb.AdminRole.FormComponent, {:saved, role}}, socket) do
