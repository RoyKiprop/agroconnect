defmodule AgroconnectWeb.Users.Bookings.Index do
  ...
  @impl true
  def handle_info({AgroconnectWeb.BookingLive.FormComponent, {:saved, booking}}, socket) do
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:noreply, stream_delete(socket, :booking, booking)}
  end
end
