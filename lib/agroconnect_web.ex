defmodule AgroconnectWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: AgroconnectWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AgroconnectWeb.Layouts, :app}

      unquote(html_helpers())
    end
  end

  def vet_live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AgroconnectWeb.Layouts, :vet}
  ...
  def user_live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AgroconnectWeb.Layouts, :user}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: AgroconnectWeb.Router,
        statics: AgroconnectWeb.static_paths()
    end
  end
