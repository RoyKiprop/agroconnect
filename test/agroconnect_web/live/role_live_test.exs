defmodule AgroconnectWeb.RoleLiveTest do
  use AgroconnectWeb.ConnCase

  import Phoenix.LiveViewTest
  import Agroconnect.AccountsFixtures

  @create_attrs %{name: "some name", description: "some description", deleted_at: "2025-03-08T18:02:00Z"}
  @update_attrs %{name: "some updated name", description: "some updated description", deleted_at: "2025-03-09T18:02:00Z"}
